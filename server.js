...
async function handleAnalyze(req, res) {
  ...
  const prompt = [
    ...
    "",
    "JSON 형식:",
    '{"passage":{"topicKo":"한글 주제","topicEn":"English topic","keywords":[{"en":"keyword","ko":"키워드"}],"logic":[{"type":"지문의 실제 전개에 맞는 라벨","text":"해당 부분 요약"},{"type":"다음 단계 라벨","text":"해당 부분 요약"}]},"sentences":[{"original":"English sentence","translation":"자연스러운 한국어 해석","points":{"structure":"주어/동사 등","pronouns":"it = ...","flow":"역접/예시/원인 등"},"chunks":[{"text":"English chunk","translation":"청크 뜻","grammar":"내신 포인트가 있을 때만 짧게","role":"subject"}]}]}',
    "",
    "영어 지문:",
    text,
  ].join("\n");
